...
!function() {
    ...
    function t(e, n) {
        ...
        if ("function" == typeof n)
            for (var i = new r(e), a = 1, o = arguments.length; o > a; ++a)
                t.callbacks.push(i.middleware(arguments[a]));
        else
            "string" == typeof e ? t["string" == typeof n ? "redirect" : "show"](e, n) : t.start(e)
    }
    function e(e) {
        if (!e.handled) {
            var n;
            n = m ? v + f.hash.replace("#!", "") : f.pathname + f.search,
            n !== e.canonicalPath && (t.stop(),
            e.handled = !1,
            f.href = e.canonicalPath)
        }
    }
    function n(t, e) {
        ...
        this.path = t.replace(v, "") || "/",
        m && (this.path = this.path.replace("#!", "") || "/"),
        this.title = document.title,
        this.state = e || {},
        this.state.path = t,
        this.querystring = ~n ? i(t.slice(n + 1)) : "",
        this.pathname = i(~n ? t.slice(0, n) : t),
        this.params = {},
        this.hash = "",
        !m) {
    ...
    function a(e) {
        if (1 === o(e) && !(e.metaKey || e.ctrlKey || e.shiftKey || e.defaultPrevented)) {
            for (var n = e.target; n && "A" !== n.nodeName; )
                n = n.parentNode;
    ...
    var h = function() {
        ...
        function i(t, r, i) {
            for (var a = [], s = 0, h = t.length; h > s; s++)
                a.push(o(t[s], r, i).source);
    ...
    var c, u, p = document.ontouchstart ? "touchstart" : "click", f = "undefined" != typeof window && (window.history.location || window.location), l = !0, d = !0, v = "", m = !1;
    t.callbacks = [],
    t.exits = [],
    t.current = "",
    t.len = 0,
    ...
    t.start = function(e) {
        ...
        !c && (c = !0,
        !1 === e.dispatch && (l = !1),
        !1 === e.decodeURLComponents && (d = !1),
        !1 !== e.popstate && window.addEventListener("popstate", w, !1),
        !1 !== e.click && window.addEventListener(p, a, !1),
        !0 === e.hashbang && (m = !0),
        l)) {
    ...
    t.stop = function() {
        ...
        t.len = 0,
        c = !1,
        window.removeEventListener(p, a, !1),
    ...
    ,
    t.back = function(e, n) {
        t.len > 0 ? (history.back(),
        t.len--) : e ? setTimeout(function() {
            t.show(e, n)
    ...
    t.exit = function(e) {
        if ("function" == typeof e)
            return t.exit("*", e);
        for (var n = new r(e), i = 1, a = arguments.length; a > i; ++i)
            t.exits.push(n.middleware(arguments[i]))
    }
    ,
        ...
        function(n) {
            if (e)
                if (n.state) {
                    ...
                    t.show(f.pathname + f.hash, void 0, void 0, !1)
        }
    }();
    t.sameOrigin = s,
